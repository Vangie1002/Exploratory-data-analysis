...
#---------------------------question , in summary it shows age from 20-80,but in sub group is 1-61 ) 
#----- visualization
...
#----- Chart 4shows in age group younger than 30,in defferent education group, the customer behavior relationship between age and brand.

a + geom_density(aes(fill=Brand),colour="black",alpha=0.4)+facet_grid(Zipcode~Elevel,scale="free")+xlab("Age <30")
#----- Chart 5 shows in age group younger than 30 ,in defferent education group and different Zipcode area , the customer behavior relationship with brand.
...
#----- Chart 6 shows in age group 31-60 ,in defferent education group, the customer behavior relationship between age and brand.
b + geom_density(aes(fill=Brand),colour="black",alpha=0.4)+facet_grid(Zipcode~Elevel,scale="free")+xlab("Middel(30-60")
#----- Chart 7 shows in age group 31-60,in defferent education group and different Zipcode area , the customer behavior relationship with brand.
...
#----- Chart 8 shows in age group older than 60 ,in defferent education group, the customer behavior relationship between age and brand.
c + geom_density(aes(fill=Brand),colour="black",alpha=0.4)+facet_grid(Zipcode~Elevel,scale="free")+xlab("Senior(>60)")
#----- Chart 9 shows in age group older than 60 ,in defferent education group and different Zipcode area , the customer behavior relationship with brand.
